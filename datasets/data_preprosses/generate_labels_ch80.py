...
def main():
    ROOT_DIR = "/data/gsw/RawData/Cholec80"
    SAVE_DIR = '/data/gsw/Data/cholec80'
    ...
    for video_name in VIDEO_NAMES:
        ...
        phase_path = os.path.join(SAVE_DIR, 'phase_annotations', video_name.replace('.mp4', '-phase.txt'))
        ...
        for frame_id in tqdm(range(0, int(frames))):
            if frame_id % fps == 0:
                ...
                info['frame_id'] = int(frame_id // fps)
