...
def save_model(
    args, epoch, model, model_without_ddp, optimizer, loss_scaler, model_ema=None,filename=''
):
    output_dir = Path(args.output_dir)
    epoch_name = str(epoch)
    if loss_scaler is not None:
        checkpoint_paths = [output_dir /filename/ ("checkpoint-%s.pth" % epoch_name)]
        ...
        model.save_checkpoint(
            save_dir=args.output_dir + '/' + filename,
